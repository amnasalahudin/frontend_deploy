...
function ViewProduct() {
      ...
      if (token) {
        ...
        try {
          const response = await axios.get(
            `https://tired-erin-gazelle.cyclic.app/api/product/brands/${brandId}/products`,
            options
          );
  ...
  const deleteProduct = async (productId) => {
    ...
    if (token) {
      ...
      try {
        await axios.delete(`https://tired-erin-gazelle.cyclic.app/api/product/delete/${productId}`, options);
  ...
  const saveUpdatedProduct = async () => {
    ...
    if (token) {
      ...
      try {
        await axios.patch(
          `https://tired-erin-gazelle.cyclic.app/api/product/${updatedProductId}`,
          updatedProduct,
          options
        );
