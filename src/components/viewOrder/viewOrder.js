...
function ViewOrder() {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            if (token) {
                ...
                try {
                    const response = await axios.get('https://tired-erin-gazelle.cyclic.app/api/order/orders/seller', options);
 ...
 const handleSendSms = async () => {
  ...
  try {
      await axios.post(
          'https://tired-erin-gazelle.cyclic.app/api/twilio/send-sms',
  ...
  const handleSubmit = async () => {
    ...
    try {
        const response = await axios.patch(
            `https://tired-erin-gazelle.cyclic.app/api/order/orders/${orderToUpdate._id}`,
            { status: newStatus },
            options
        );
