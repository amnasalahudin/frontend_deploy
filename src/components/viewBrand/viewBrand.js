...
function ViewBrand() {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      ...
      if (token) {
        ...
        try {
          const response = await axios.get('https://tired-erin-gazelle.cyclic.app/api/brand/viewbrand', options);
  ...
  const deleteBrand = async (id) => {
    ...
    if (token) {
      ...
      try {
        await axios.delete(`hhttps://tired-erin-gazelle.cyclic.app/api/brand/deleteBrand/${id}`, options);
  ...
  const saveUpdatedPost = async () => {
    ...
    if (token) {
      ...
      try {
        await axios.patch(`https://tired-erin-gazelle.cyclic.app/api/brand/editBrand/${updatedPostId}`, updatedPost, options);
